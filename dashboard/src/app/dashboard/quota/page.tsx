            ...
            {isModelFirstOnlyView && modelFirstSummary ? (
              <>
                ...
                <div className="rounded-lg border border-[#e5e5e5] bg-white px-2.5 py-2">
                  ...
                  <p className="mt-0.5 text-xs font-semibold text-black">{modelFirstSummary.staleAccounts}</p>
                </div>
                <div className="rounded-lg border border-[#e5e5e5] bg-white px-2.5 py-2">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.08em] text-[#777169]">
                    Closest Reset{" "}
                ...
                <div className="rounded-lg border border-[#e5e5e5] bg-white px-2.5 py-2">
                  ...
                  <p className="mt-0.5 text-xs font-semibold text-black">{modelFirstSummary.groups.length}</p>
                </div>
              </>
            ) : (
              <>
